            ...
            >
                <Box textAlign="left">
                    <Text color={"gray.500"} maxW={"3xl"}>
                        Do you have the fear of losing your money in the stock
                        market? Do you want to try the market out without
                        putting your money at stake? Well,{" "}
                    ...
                    <Text color={"gray.500"} maxW={"3xl"} marginTop="20px">
                        ...
                        website to try mock trading using REAL stock market data
                        from the USA stock market. The{" "}
                        <Text as={"span"} color={"primary.400"}>
                            Dashboard
                        </Text>{" "}
                    ...
                    <Text color={"gray.500"} maxW={"3xl"} marginTop="20px">
                        Thinking about investing in mutual funds instead? Head
                        over to the{" "}
                        <Text as={"span"} color={"primary.400"}>
                            Calculators
                        </Text>{" "}
                        page and check out how much returns you could get if you
                        invest by using our{" "}
                        <Text as={"span"} color={"primary.400"}>
                            SIP Calculator
                        </Text>{" "}
                        ...
                        . Even better, your profits are adjusted for inflation!
                        So you know, exactly how much your profits will be after
                        maturity!
                    </Text>
                </Box>
